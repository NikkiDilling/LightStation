...
Serial.println(BlueValue);
  ...
  int brightnessR = constrain(map(RedValue, 335,440,0,255),0,255);
  int brightnessG = constrain(map(GreenValue, 350,430,0,255),0,255);
  int brightnessB = constrain(map(BlueValue, 310,410,0,255),0,255);
